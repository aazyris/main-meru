...
function Lib:CreateWindow(title)
    ...
    function API:Category(name)
        ...
        function Entry:Textbox(txt, placeholder, cb)
            ...
            local box = create("TextBox", {Parent = row, Size = UDim2.new(1, 0, 0, 20), Position = UDim2.new(0, 0, 0, 18), BackgroundColor3 = Theme.Soft, BackgroundTransparency = 0.2, Text = "", PlaceholderText = placeholder or "", TextColor3 = Theme.Text, PlaceholderColor3 = Theme.MutedText, Font = Theme.Font, TextSize = 12, ClearTextOnFocus = false})
        ...
        function Entry:Dropdown(txt, list, def, cb)
            ...
            local mainBtn = create("TextButton", {Parent = Page, Size = UDim2.new(1, -5, 0, 35), BackgroundColor3 = Color3.new(0,0,0), BackgroundTransparency = 0.5, Text = "  "..txt, Font = Theme.Font, TextSize = 12, TextColor3 = Theme.Text, TextXAlignment = "Left"})
